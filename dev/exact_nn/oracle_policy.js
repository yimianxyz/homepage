...
// Logging lines only: every inserted line carries /*ORACLE*/; stripping them
// reproduces the prod source byte-for-byte (gen --verify proves it).
// source: js/predator_cheap.js sha256=a706d6640bdfbde3a0a614471210b34c7f420aa79b083a00a4b7204482ee5421
...
(function () {
    ...
    function planCheap(s) {
        ...
        for (var rk = 0; rk < cfg.K_roll && rk < pidx.length; rk++) {
            ...
            /*ORACLE*/ if (window.__oracle) window.__oracle.roll(ci, rr.catches, boot);
        }
        ...
        /*ORACLE*/ if (window.__oracle) window.__oracle.planEnd(pidx, score, bi);
    ...
    /*ORACLE*/ (function () { var __pf = window.__cheap.force;
    /*ORACLE*/   window.__cheap.force = function (pred, boids) { var r = __pf(pred, boids);
    /*ORACLE*/     if (window.__oracle) window.__oracle.frameEnd(target, frame, egBoid, boids, r, pred);
    /*ORACLE*/     return r; }; })();
